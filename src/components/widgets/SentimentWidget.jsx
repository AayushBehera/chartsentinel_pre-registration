...
export function SentimentWidget() {
    ...
    return (
        <div className="bg-black/80 border border-white/10 rounded-xl p-4 w-full h-full flex flex-col justify-between">
            <h3 className="text-slate-400 text-sm font-semibold mb-2">AI Sentiment</h3>
            ...
            <div className="relative h-32 w-full flex items-center justify-center">
                ...
                <div className="absolute bottom-0 text-center">
                    ...
                    <div className="text-[10px] text-slate-400 uppercase tracking-widest">Greed</div>
                </div>
            </div>

            <div className="space-y-2 mt-2">
                <div className="flex justify-between text-xs">
                    <span className="text-slate-500">Social Volume</span>
