...
export function ReportCardVisual() {
    return (
        <div className="bg-white/5 border border-white/10 rounded-xl p-3 w-full mt-4">
            ...
            <div className="h-16 bg-black/20 rounded p-2 text-[10px] text-slate-500 font-mono overflow-hidden">
...
export function ActionButtonVisual() {
    return (
        <div className="flex gap-4 mt-6 justify-center">
            <button className="px-6 py-2 rounded-lg bg-[rgba(34,197,94,0.15)] text-[#22c55e] border border-green-500/30 hover:bg-green-500/30 transition-colors text-sm font-bold">
                BUY
            </button>
            <button className="px-6 py-2 rounded-lg bg-[rgba(239,68,68,0.15)] text-[#ef4444] border border-red-500/30 hover:bg-red-500/30 transition-colors text-sm font-bold">
                SELL
            </button>
        </div>
    )
